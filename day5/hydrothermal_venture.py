...
def count_points_where_at_least_two_lines_overlap(
    ...
    points_where_at_least_two_lines_overlap = [k for k, v in points_of_vents.items() if v >= 2]
...
def main():
    ...
    lines_of_vents = _parse_input("/home/eileen/workspace/adventofcode2021/day5/input.txt")

    count_1 = count_points_where_at_least_two_lines_overlap(lines_of_vents, ConsideredDirection.hori_verti)
    logger.info(f"Part 1 answer is '{count_1}'")  # 4745

    count_2 = count_points_where_at_least_two_lines_overlap(lines_of_vents, ConsideredDirection.hori_verti_diagonal)

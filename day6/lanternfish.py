    ...
    for i in range(n):
        for age in range(8+1):
            if age == 0:
                ...
                lanternfish_age_to_amount_dict[age-1] = lanternfish_age_to_amount_dict[age]
...
def main():
    ...
    lanternfish_amount_after_256_days = lanternfish_amount_after_n_days_dict_solution(list_of_lanternfish_ages, 256)
    logger.info(f"Part 2 answer is '{lanternfish_amount_after_256_days}'")  # 1765974267455
